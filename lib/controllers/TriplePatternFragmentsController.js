...
TriplePatternFragmentsController.prototype._handleRequest = function (request, response, next) {
  ...
  if (!datasourceSettings || !datasourceSettings.datasource.supportsQuery(query) ||
      !datasourceSettings.datasource.supportedFeatures.triplePattern) {
    return next();
  }
...
TriplePatternFragmentsController.prototype._createTemplateUrl = function(query, datasourceUrl) {
...
function (request, query, datasourceSettings) {
  ...
  return {
    datasource: _.assign(_.omit(datasourceSettings, 'datasource'), {
      ...
      templateUrl: this._createTemplateUrl(query, datasourceUrl),
    }),
    fragment: {
      url: fragmentUrl,
      pageUrl: pageUrl,
