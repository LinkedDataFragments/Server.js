...
TriplePatternFragmentsController.prototype._handleRequest = function (request, response, next) {
  ...
  if (!datasourceSettings || !datasourceSettings.datasource.supportsQuery(query) ||
      !this.supportsDatasource(datasourceSettings.datasource, query))
    return next();
  ...
  switch (request.method) {
    case 'GET':
      ...
      break;
    case 'POST':
      if (!datasourceSettings.datasource.supportsInsert(query))
        return next();
      datasourceSettings.datasource.insert(query, request,
