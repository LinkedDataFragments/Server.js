...
Controller.prototype._negotiateView = function (viewName, request, response) {
  ...
  response.setHeader('Vary', 'Accept');
  // Try to negotiate a view
  var viewDetails;
  try { viewDetails = this._views.getView(viewName, request); }
  catch (error) { return null; }
  // Set the content type of the negotiated view, and return the view
...
Controller.prototype._sendError = function (request, response, error, status, writerSettings) {
