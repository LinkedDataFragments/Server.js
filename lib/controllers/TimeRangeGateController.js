...
var QuadPatternFragmentsController = require('./QuadPatternFragmentsController'),
    url = require('url'),
    _ = require('lodash'),
    Util = require('../Util');
...
function TimeRangeGateController(options) {
  ...
  options = options || {};
  QuadPatternFragmentsController.call(this, options);
  this._routers = options.routers || [];
}
QuadPatternFragmentsController.extend(TimeRangeGateController);
