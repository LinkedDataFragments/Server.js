...
function TemporalDatasource(options) {
  ...
  this._timeRangeBaseUrl = "/" + options.datasourceName; // TODO: settings.datasource.url, like in views?
  this._timeRangeGateUrl = this._timeRangeBaseUrl + "/timeRangeGate"; // TODO: more generic?
