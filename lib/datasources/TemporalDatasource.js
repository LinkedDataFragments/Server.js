...
// TODO: either make new timeranges based on the contents of the previous timerange and see if it still is valid in there
// TODO: or immediately make new timeranges once large timeintervals are added
...
TemporalDatasource.prototype.insert = function (query, request, callback) {
  ...
  if (initial && final) {
    ...
    if (!this._currentTimeRange) {
      // TODO: make a datasource in this case?
    ...
    if (isIntervalAfter(currentInterval, interval)) {
      // TODO: modify
      this._currentTimeRange.insert(query, request, callback);
    } else {
      // TODO: make a resolution for this?
