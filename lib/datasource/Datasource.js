...
Datasource.prototype.select = function (query) {
  ...
  return this._createTripleStream(query);
};

// Creates a triple stream for the given query
Datasource.prototype._createTripleStream = function (query) {
  throw new Error('_createTripleStream has not been implemented');
};
