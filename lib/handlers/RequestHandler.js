...
function RequestHandler(options) {
  ...
  // Set up base URL (in case we're behind a proxy, this is the true external URL)
...
RequestHandler.prototype.handleRequest = function (request, response) {
  // Add `parsedUrl` field to request, with the parsed external URL
...
RequestHandler.prototype._handleRequest = function (request, response) {
  return false;
};
