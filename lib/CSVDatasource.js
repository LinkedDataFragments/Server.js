...
CSVDatasource.prototype = {
  ...
  query: function (subject, predicate, object) {
    ...
    return q.all([triples]).spread(function (triples) {
      ...
      var pattern = self._triple.subject + " " + self._triple.predicate + " " + self._triple.object + " " + ".";
  ...
  _isPartOfLDFragment: function (triple) {
    return (this._triple.subject === "" || this._triple.subject === "<" + triple.subject + ">") &&
           (this._triple.predicate === "" || this._triple.predicate === "<" + triple.predicate + ">") &&
           (this._triple.object === "" || this._triple.object.substr(1, this._triple.object.length - 2) == triple.object || this._triple.object == triple.object);
  },
};
