...
module.exports.instantiate = function(config, description, includePath) {
...
module.exports.instantiateAll = function(config, descriptions, includePath) {
  var self = this;
  return (_.isArray(descriptions) ? _.map : _.mapValues)
  (descriptions, function (description) { return self.instantiate(config, description, includePath); });
};
