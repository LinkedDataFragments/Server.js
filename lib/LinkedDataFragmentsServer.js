...
function LinkedDataFragmentsServer(options) {
  ...
  server.on('request', function (request, response) {
    ...
    try { server._authenticate(request, response,
      function (request, response) { server._handleRequest(request, response); });
    }
