...
var prototype = LinkedDataFragmentsServer.prototype = {
  ...
  queryDatasource: function (req, res) {
    ...
    var self = this, host = req.headers.host,
        ...
        writer = this.createFragmentWriter(req, res, { query: query,
  ...
  respondNotFound: function (req, res) {
    var datasets = _.mapValues(this._datasources, function (name, key) {
        ...
        writer = this.createFragmentWriter(req, res, options);
    res.writeHead(404);
  ...
  createFragmentWriter: function (req, res, options) {
    var defaults = { prefixes: this._prefixes },
        contentType = this.negotiate(req, res, fragmentWriters),
  ...
  // Performs content negotiation for the response
  negotiate: function (req, res, options) {
    conneg.acceptedTypes(req, res);
    var type, types = req.acceptableTypes || ['*/*'];
