...
var prototype = LinkedDataFragmentsServer.prototype = {
  ...
  queryDatasource: function (req, res) {
    ...
    var self = this,
        ...
        prefixes = _.extend(_.clone(this._prefixes), { '': baseURL }),
        ...
        writer = new Writer(res, { query: query,
          dataset: datasourceName, datasetURL: baseURL + '/' + datasourceName,
          pattern: pattern, fragmentURL: baseURL + req.url,
          prefixes: prefixes,
        }),
    ...
    datasource.query(pattern, writeTriple, _.once(writeMetadata), _.once(end));
  },
