...
var prototype = LinkedDataFragmentsServer.prototype = {
  ...
  queryDatasource: function (req, res) {
    ...
    // Treat blank nodes as unknowns
    if (!query.subject   || blankNodePattern.test(query.subject))
      delete query.subject;
    if (!query.predicate || blankNodePattern.test(query.predicate))
      delete query.predicate;
    if (!query.object    || blankNodePattern.test(query.object))
      delete query.object;
