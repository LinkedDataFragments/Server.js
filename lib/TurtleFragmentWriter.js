...
TurtleFragmentWriter.prototype = {
  ...
  write: function (outputStream, results) {
    ...
    addTriple(dataset, hydra + 'search', '_:tripleTemplate');
    addTriple('_:tripleTemplate', hydra + 'template', '"' + formTemplateUri + '"');
    addTriple('_:tripleTemplate', hydra + 'mappings', '_:subject');
    addTriple('_:tripleTemplate', hydra + 'mappings', '_:predicate');
    addTriple('_:tripleTemplate', hydra + 'mappings', '_:object');
