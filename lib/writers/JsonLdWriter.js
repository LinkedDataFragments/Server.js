...
JsonLdWriter.prototype._createWriter = function (destination, settings) {
  ...
  return {
    ...
    data: function (s, p, o, g) {
      data.push(createTriple(s, p, o, g));
    },
...
function createTriple(subject, predicate, object, graph) {
  var triple = {
  ...
  if (graph && this._patternFields.indexOf('graph') >= 0) {
      triple = { 'graph': graph, 'triple': triple };
  }
  return triple;
}
