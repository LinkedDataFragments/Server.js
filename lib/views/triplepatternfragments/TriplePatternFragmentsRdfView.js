...
TriplePatternFragmentsRdfView.prototype._generateRdf = function (settings, data, metadata, done) {
  ...
  settings.resultStream.on('metadata', function (meta) {
    self.sendMetadata(metadata, fragment, query, datasource, meta);
...
TriplePatternFragmentsRdfView.prototype.sendMetadata = function(metadata, fragment, query, datasource, meta) {
