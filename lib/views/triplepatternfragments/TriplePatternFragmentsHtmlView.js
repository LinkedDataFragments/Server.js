...
TriplePatternFragmentsHtmlView.prototype._render = function (settings, request, response) {
  ...
  function renderHtml() {
    ...
    self._renderTemplate('triplepatternfragments/' + template, settings, response);
  }
};
