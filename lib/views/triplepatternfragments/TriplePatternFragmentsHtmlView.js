...
function TriplePatternFragmentsHtmlView(settings, viewNameOverride) {
...
TriplePatternFragmentsHtmlView.prototype._getViewDirectory = function() {
...
TriplePatternFragmentsHtmlView.prototype._render = function (settings, request, response, done) {
  ...
  function renderHtml() {
    ...
    self._renderTemplate(self._getViewDirectory() + template, settings, request, response, done);
  }
};
