...
RdfView.prototype._getViewExtensions = function (type, request, response) {
  return !this._defaults.views ? [] :
         _.uniq(this._defaults.views.getViews(this.name + ':' + type)
                                    .map(function (s) { return s.view; })
                                    .filter(function (v) { return v instanceof RdfView; }));
};
