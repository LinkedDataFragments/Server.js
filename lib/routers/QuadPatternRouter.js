...
QuadPatternRouter.prototype._pureIRIFields = TriplePatternRouter.prototype._pureIRIFields.concat(['graph']);
...
QuadPatternRouter.prototype.extractQueryParams = function (request, query) {
  ...
  query.features.quadPattern = query.graph && query.features.triplePattern;
};
