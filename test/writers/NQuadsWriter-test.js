var NQuadsWriter = require('../../lib/writers/NQuadsWriter'),
    fs = require('fs'),
    path = require('path');

describe('NQuadsWriter', function () {
  describe('The NQuadsWriter module', function () {
    it('should be a function', function () {
      NQuadsWriter.should.be.a('function');
    });

    it('should be a NQuadsWriter constructor', function () {
      new NQuadsWriter().should.be.an.instanceof(NQuadsWriter);
    });

    it('should create new NQuadsWriter objects', function () {
      NQuadsWriter().should.be.an.instanceof(NQuadsWriter);
    });
  });

  describe('A NQuadsWriter instance', function () {
    ...
    describe('when writeFragment is called', function () {
      describe('with an empty triple stream', function () {
        ...
        it('should only write data source metadata', function () {
          result.buffer.should.equal(asset('empty-fragment.nq'));
        });
      });
      ...
      describe('with a non-empty triple stream that writes metadata first', function () {
        ...
        it('should write data and metadata', function () {
          result.buffer.should.equal(asset('basic-fragment.nq'));
        });
      });
      ...
      describe('with a non-empty triple stream that writes metadata afterwards', function () {
        ...
        it('should write data and metadata', function () {
          result.buffer.should.equal(asset('basic-fragment-metadata-last.nq'));
        });
      });
