var TrigWriter = require('../../lib/writers/TrigWriter'),
    fs = require('fs'),
    path = require('path');

describe('TrigWriter', function () {
  describe('The TrigWriter module', function () {
    it('should be a function', function () {
      TrigWriter.should.be.a('function');
    });

    it('should be a TrigWriter constructor', function () {
      new TrigWriter().should.be.an.instanceof(TrigWriter);
    });

    it('should create new TrigWriter objects', function () {
      TrigWriter().should.be.an.instanceof(TrigWriter);
    });
  });

  describe('A TrigWriter instance', function () {
    ...
    describe('when writeFragment is called', function () {
      describe('with an empty triple stream', function () {
        ...
        it('should only write data source metadata', function () {
          result.buffer.should.equal(asset('empty-fragment.trig'));
        });
      });
      ...
      describe('with a non-empty triple stream that writes metadata first', function () {
        ...
        it('should write data and metadata', function () {
          result.buffer.should.equal(asset('basic-fragment.trig'));
        });
      });
      ...
      describe('with a non-empty triple stream that writes metadata afterwards', function () {
        ...
        it('should write data and metadata', function () {
          result.buffer.should.equal(asset('basic-fragment-metadata-last.trig'));
        });
      });
