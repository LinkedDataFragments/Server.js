        ...
        (
          [
            ...
            [
              ...
              { limit: 1 },
              { limit: 1, features: { triplePattern: true }, subject: dataFactory.namedNode('http://example.org/foo#bar') },
            ],
            [
            ...
            [
              ...
              { limit: 1, features: { a: true } },
              { limit: 1, features: { a: true, triplePattern: true }, predicate: dataFactory.namedNode('http://example.org/foo#bar') },
            ],
            [
            ...
            [
              ...
              { limit: 1 },
              { limit: 1, features: { triplePattern: true }, object: dataFactory.namedNode('http://example.org/foo#bar') },
            ],
            [
            ...
            [
              ...
              'should add the object to the query',
              { limit: 1 },
              { limit: 1, features: { triplePattern: true }, object: dataFactory.literal('foo') },
            ],
            [
              ...
              'should add the object to the query',
              { limit: 1 },
              { limit: 1, features: { triplePattern: true }, object: dataFactory.literal('foo', 'nl-be') },
            ],
            [
              ...
              'should add the object to the query',
              { limit: 1 },
              { limit: 1, features: { triplePattern: true }, object: dataFactory.literal('foo', dataFactory.namedNode('http://example.org/foo#bar')) },
            ],
            [
            ...
            [
              ...
              { limit: 1 },
              { limit: 1, features: { quadPattern: true }, graph: dataFactory.namedNode('http://example.org/foo#bar') },
            ],
            [
            ...
            [
              ...
              { limit: 1 },
              { limit: 1, features: { quadPattern: true }, graph: dataFactory.defaultGraph() },
            ],
        ...
        (
          [
            ...
            [
              ...
              'should add the expanded subject to the query',
              { limit: 1 },
              { limit: 1, features: { triplePattern: true }, subject: dataFactory.namedNode('http://www.w3.org/2011/http#Connection') },
            ],
            [
              ...
              { limit: 1 },
              { limit: 1, features: { triplePattern: true }, subject: dataFactory.namedNode('bar:foo') },
            ],
            [
              'a URL with an IRI subject parameter in angular brackets',
              'http://example.org/?subject=%3Chttp%3A%2F%2Fexample.org%2Ffoo%23bar%3E',
            ...
            [
              ...
              'should add the non-expanded subject to the query',
              { limit: 1 },
              { limit: 1, features: { triplePattern: true }, subject: dataFactory.namedNode('foo:bar') },
            ],
            [
              'a URL with an empty predicate parameter',
              'http://example.org/?predicate=',
            ...
            [
              ...
              'should add the predicate to the query',
              { limit: 1 },
              { limit: 1, features: { triplePattern: true }, predicate: dataFactory.namedNode('http://example.org/foo#bar') },
            ],
            [
            ...
            [
              ...
              'should add the expanded predicate to the query',
              { limit: 1 },
              { limit: 1, features: { triplePattern: true }, predicate: dataFactory.namedNode('http://www.w3.org/2011/http#authority') },
            ],
            [
              ...
              { limit: 1 },
              { limit: 1, features: { triplePattern: true }, predicate: dataFactory.namedNode('bar:foo') },
            ],
            [
              'a URL with an IRI predicate parameter in angular brackets',
              'http://example.org/?predicate=%3Chttp%3A%2F%2Fexample.org%2Ffoo%23bar%3E',
            ...
            [
              ...
              'should add the non-expanded predicate to the query',
              { limit: 1 },
              { limit: 1, features: { triplePattern: true }, predicate: dataFactory.namedNode('foo:bar') },
            ],
            [
              'a URL with an empty object parameter',
              'http://example.org/?object=',
            ...
            [
              ...
              'should add the expanded object to the query',
              { limit: 1 },
              { limit: 1, features: { triplePattern: true }, object: dataFactory.namedNode('http://www.w3.org/2011/http#Connection') },
            ],
            [
              ...
              { limit: 1 },
              { limit: 1, features: { triplePattern: true }, object: dataFactory.namedNode('bar:foo') },
            ],
            [
              'a URL with an IRI object parameter in angular brackets',
              'http://example.org/?object=%3Chttp%3A%2F%2Fexample.org%2Ffoo%23bar%3E',
            ...
            [
              ...
              'should add the non-expanded object to the query',
              { limit: 1 },
              { limit: 1, features: { triplePattern: true }, object: dataFactory.namedNode('foo:bar') },
            ],
            [
              'a URL with a typed literal object parameter',
              'http://example.org/?object=%22foo%22%5E%5Ehttp%3A%2F%2Fexample.org%2Ffoo%23bar',
            ...
            [
              ...
              'should add the expanded graph to the query',
              { limit: 1 },
              { limit: 1, features: { quadPattern: true }, graph: dataFactory.namedNode('http://www.w3.org/2011/http#Connection') },
            ],
            [
              ...
              { limit: 1 },
              { limit: 1, features: { quadPattern: true }, graph: dataFactory.namedNode('bar:foo') },
            ],
            [
              'a URL with an IRI graph parameter in angular brackets',
              'http://example.org/?graph=%3Chttp%3A%2F%2Fexample.org%2Ffoo%23bar%3E',
            ...
            [
              ...
              'should add the non-expanded graph to the query',
              { limit: 1 },
              { limit: 1, features: { quadPattern: true }, graph: dataFactory.namedNode('foo:bar') },
            ],
          ] as Array<[string, string, string, Query, Query]>
        )
          .forEach((args) => { extractQueryParams(router, ...args); });
