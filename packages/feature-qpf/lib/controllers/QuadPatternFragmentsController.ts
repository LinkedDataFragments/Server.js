...
import type { ControllerOptions, LdfRequestWithUrl, LdfResponse, Query, QueryFeatures, RouterRequest, ViewSettings } from '@ldf/core/lib/types';
...
export class QuadPatternFragmentsController extends Controller {
  ...
  protected _createFragmentMetadata(request: LdfRequestWithUrl, query: Query, datasourceSettings: Datasource): ViewSettings & { fragment: FragmentInfo } {
