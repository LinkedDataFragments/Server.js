...
[![npm version](https://badge.fury.io/js/%40ldf%2Fdatasource-jsonld.svg)](https://www.npmjs.com/package/@ldf/datasource-rdfa)
...
```
{
  "@context": [
    ...
    "https://linkedsoftwaredependencies.org/bundles/npm/@ldf/datasource-rdfa/^0.0.0/components/context.jsonld",
  ],
  // Same as above...
}
```
